...
var createGlobalBaseMapOptions = function(terria, bingMapsKey, digitalGlobeApiKey) {
    ...
    openStreetMap.url = 'https://a.tile.openstreetmap.org';
    ...
    stamenWatercolor.url = 'https://stamen-tiles.a.ssl.fastly.net/watercolor/';
    ...
    naturalEarthII.url = 'https://maps.leylines.ch:8080/geoserver/baseMaps/wms';
