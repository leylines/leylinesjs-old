...
var defaultConfigParameters = {
  ...
  regionMappingDefinitionsUrl: "build/LeylinesJS/data/regionMapping.json",
...
var Terria = function(options) {
  ...
  this.baseUrl = defaultValue(options.baseUrl, "build/LeylinesJS/");
   ...
   */
  this.appName = defaultValue(options.appName, "LelyinesJS App");
   ...
   */
  this.supportEmail = defaultValue(options.supportEmail, "info@leylines.net");
